...
import { CustomButton, CountBox, Loader } from "../components/index";
...
const CampaignDetails = () => {
  ...
  console.log("state.amountCollected", state.amountCollected);
        ...
        <div className="flex-1">
          ...
          <div className="mt-[20px] flex flex-col p-4 bg-[#1c1c24] rounded-[10px]">
            ...
            <div className="mt-[30px]">
              ...
              />
              <div className="my-[20px] p-4 bg-[#13131a] rounded-[10px] text-left">
